...
api_id = "39927405"
api_hash = "42cf249b3b3c4023e526b8fa49d87928"
...
async def check_spam():
    try:
        ...
        list = db.get("accounts")
        for i in list:
            c = Client('::memory::', in_memory=True, api_hash='42cf249b3b3c4023e526b8fa49d87928', api_id=39927405,lang_code="ar", no_updates=True, session_string=i["session"])
            try:
            	await c.start()
            except:
            	continue
...
async def check(session):
    c = Client('::memory::', in_memory=True, api_hash='42cf249b3b3c4023e526b8fa49d87928', api_id=39927405,lang_code="ar", no_updates=True, session_string=session)
    try:
        await c.start()
    except:
        return False
